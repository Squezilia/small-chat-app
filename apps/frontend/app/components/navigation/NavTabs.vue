<template>
  ...
  >
    <div
      ...
      class="absolute top-1/2 h-9 w-20 -translate-y-1/2 z-0 bg-accent group-hover/wrapper:opacity-50 group-active/wrapper:opacity-0 rounded-md transition-all duration-100 opacity-0"
    />
    <div
      ref="ActiveWrapper"
